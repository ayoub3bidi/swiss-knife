...
def main():
    ...
    parser.add_argument(
        "paths", nargs="+", help="Directories or files to scan"
    )
    parser.add_argument(
        "--algorithm", choices=DuplicateFinder.ALGORITHMS, default="sha256",
    ...
    parser.add_argument(
        "--keep-strategy", choices=["first", "last", "shortest_name", "longest_name"],
        default="first", help="Strategy for choosing which file to keep"
    )
    parser.add_argument(
        "--export-json", help="Export results to JSON file"
    )
    parser.add_argument(
