...
from ..core import validate_path, confirm_destructive_action, SafetyError
...
class DuplicateFinder:
    ...
    def delete_duplicates(self, duplicates: Dict[str, List[Path]], 
                         keep_strategy: str = 'first', force: bool = False) -> int:
...
def find_duplicates(paths: List[str], algorithm: str = 'sha256', 
                   min_size: int = 0) -> Dict[str, List[str]]:
