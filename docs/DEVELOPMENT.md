...
- [ ] `make check-cli` passes (help + `--version` on all four CLIs)
- [ ] Security scan clean
...
6. Verify with neutral PyPI install (see AGENTS.md): `pip install 'swiss-knife-py[all]==X.Y.Z'` then `sk-duplicates --version`
