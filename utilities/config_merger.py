...
Merge and manage configuration files across environments (JSON, YAML, TOML, INI).
"""
...
class ConfigMerger:
    ...
    def save_config(self, data: Dict, filepath: Path, format_type: Optional[str] = None):
    ...
    def merge_files(self, base_file: Path, *override_files: Path, 
...
Strategies: override (default), merge (deep), append (lists)
    ...
    parser.add_argument('files', nargs='+', type=Path,
                       help='Configuration files (first is base)')
    
    parser.add_argument('-o', '--output', type=Path,
                       help='Output file')
    parser.add_argument('--strategy', choices=['override', 'merge', 'append'],
                       default='override',
    ...
    parser.add_argument('--print', action='store_true',
                       help='Print merged result to stdout')
