...
from swiss_knife.automation.password_generator import PasswordGenerator, generate_password
...
class TestPasswordGenerator:
    ...
    def test_generate_impossible_requirements(self):
        """Test password generation with impossible requirements."""
        generator = PasswordGenerator()
    ...
    def test_check_strength_empty(self):
        """Test strength checking for empty password."""
        generator = PasswordGenerator()
    ...
    def test_check_strength_weak(self):
        """Test strength checking for weak password."""
        generator = PasswordGenerator()
    ...
    def test_check_strength_strong(self):
        """Test strength checking for strong password."""
        generator = PasswordGenerator()
    ...
    def test_check_strength_common_password(self):
        """Test strength checking for common password."""
        generator = PasswordGenerator()
    ...
    def test_check_strength_repetitive(self):
        """Test strength checking for repetitive password."""
        generator = PasswordGenerator()
